<?php
    ...
    $pdf->SetX(20);
    $pdf->SetFont('Arial', 'I', 9);
    $pdf->Cell(60, 15, '', 'LR', 0, 'L');
    $pdf->Cell(50, 15, '', 'LR', 0, 'L');
    $pdf->Cell(55, 15, '', 'LR', 0, 'L');
    $pdf->Ln();
    $pdf->SetX(20);
    $pdf->Cell(60, 6, utf8_decode('Elaboró: ') . $Elaboro, 'LR', 0, 'L');
    $pdf->Cell(50, 6, utf8_decode('Aprobó: '), 'LR', 0, 'L');
    $pdf->Cell(55, 6, utf8_decode('Recibí Conforme: '), 'LR', 0, 'L');
    $pdf->Ln();
    $pdf->SetX(20);
    $pdf->Cell(165, 0, '', 'T');
