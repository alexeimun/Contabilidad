    ...
    if (isset($_SESSION['login']) != '') {
        ...
        if (isset($_POST['btnGuardar']) != '') {
            if ($_POST['txtCuenta'] != 0) {
                ...
                echo '<script > alert("Se modificó el concepto correctamente.");self.location = "ConceptosGI.php" </script>';

            } else echo '<script >alert("Debe seleccionar una cuenta."); self.location = "ModificarConceptoGI.php" </script>';
        }
