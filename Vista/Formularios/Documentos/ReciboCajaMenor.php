...
<?php
    ...
    if (isset($_POST['btnFinalizar']) != '') {
        ...
        if ($_POST['cmbCiudad'] == '0')
            ...
            $Documentos->InsertaMovimiento($_POST['cmbTercero'], $_POST['cmbConcepto'], 0, 'C', $Consecutivo, 0, 0, 'desc', 'D',
                1, $_POST['txtValor'], 0, '', $_SESSION['login'][0]["ID_USUARIO"], $_SESSION['login'][0]["ID_EMPRESA"], 'Con', '', 0, '',
                $_POST['cmbCiudad'], $_POST['Codigo'], 'RECIBO_CAJA_MENOR');

            $_SESSION['ConsecutivoCM'] = $Consecutivo;

            $Documentos->ActualizaConsecutivo($Consecutivo, $_SESSION['login'][0]["ID_EMPRESA"], 'RECIBO_CAJA_MENOR');
