...
<?php
    ...
    session_start();
    if (isset($_SESSION['login']) == '' || $_SESSION['permisos'][5][1] == 0)
    ...
    $Tercero = '<option value ="0">-- Seleccione Un Tercero --</option>';
        ...
        <div id="main">
            <center>
                ...
                <form action="">
                    ...
                    <input type="hidden" name="nota"></input>
                </form>
    ...
    $(document).ready(function () {
        ...
        //Campo Inicial
        {
            ...
            ('<div>'
                ...
                //# Filas
            + ' <div><div  class="btnAzul" style="height: 13px;width: 24px;padding: 6px">' + (FieldCount + 1) + '</div></div>'
        ...
        function Evaluar() {
            ...
            $('#contenedor div').each(function (index, element) {
                ...
                if ($(element).find('select#cmbTercero').val() == 0) {
                    erTercero = true;
                    return false;
                }
