...
<script>
    function ValidaUsuario() {
        $("#botones").load("../Parametros/Validaciones.php?action=insertarusuario&txtEmail=" +
        document.getElementById('txtEmail').value + "&txtDocumento=" + document.getElementById('txtDocumento').value);
    }
